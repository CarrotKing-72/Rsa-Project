...
namespace Kamgam.Terrain25DLib
{
    ...
    public class Terrain25DSettings : ScriptableObject
    {
        ...
        public const string ManualURL = "https://kamgam.com/unity/2.5DTerrainManual.pdf";
        ...
        public static Terrain25DSettings GetOrCreateSettings()
        {
            if (cachedSettings == null)
            {
                ...
                if (cachedSettings == null)
                {
                    Material defaultMaterial = AssetDatabase.LoadAssetAtPath<Material>("Assets/2.5D Terrain/Materials/2.5D Terrain TriPlanar.mat");
        ...
        {
            var demoScene = AssetDatabase.LoadAssetAtPath<SceneAsset>("Assets/2.5D Terrain/Examples/2.5D Terrain Demo.unity");
            ...
            bool confirmed = EditorUtility.DisplayDialog(
                   ...
                   "Ok" + (demoScene != null ? " (open example)" : ""), "No thanks (open manual)"
                   );
            ...
            // Ensure material assigned in default settings.
            if (cachedSettings != null && cachedSettings.DefaultMaterial == null)
            {
                Material defaultMaterial =
                    AssetDatabase.LoadAssetAtPath<Material>(
                        "Assets/2.5D Terrain/Materials/2.5D Terrain TriPlanar.mat");
                cachedSettings.DefaultMaterial = defaultMaterial;
            }
        }
