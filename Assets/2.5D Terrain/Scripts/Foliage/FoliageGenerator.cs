...
namespace Kamgam.Terrain25DLib
{
	public class FoliageGenerator : MonoBehaviour
	{
        ...
        {
	        if (GeneratorSets == null || GeneratorSets.Length == 0)
	        {
		        GeneratorSets = new FoliageGeneratorSet[]
		        {
			        new FoliageGeneratorSet()
		        };
	        }

	        if (GeneratorSets[0].Settings == null)
	        {
		        Debug.LogWarning("Foliage Generator: Please configure the foliage set '" + GeneratorSets[0].Name + "' in the FoliageGenerator. Without settings the generator does not know what foliage to create and will do nothing.", this);
		        return;
	        }
