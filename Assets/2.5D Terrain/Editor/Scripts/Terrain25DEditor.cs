...
namespace Kamgam.Terrain25DLib
{
	...
	public class Terrain25DEditor : Editor
	{
		...
		{
			Application.OpenURL("https://kamgam.com/unity/2.5DTerrainManual.pdf");
		...
		{
			Terrain25DSettings.OpenOnlineManual();
		}
		...
		{
            Debug.Log("2.5D Terrain Version " + Terrain25DSettings.Version + ", Unity: " + Application.unityVersion);
		}
